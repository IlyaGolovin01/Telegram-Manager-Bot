...
Настройка через `/antireklama`:
- `/antireklama on/off` — включить/выключить
- `/antireklama links on/off` — блокировка ссылок
- `/antireklama forwards on/off` — блокировка репостов
- `/antireklama action delete|warn|ban` — действие при нарушении
